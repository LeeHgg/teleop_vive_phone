...
from control_socket_client import ControlSocketClient, control_data
...
def indy_start_teleoperation():
    control.StartTeleOp(method=control_data.TeleMethod.TELE_TASK_RELATIVE,
                        mode=control_data.TeleMode.TELE_RAW)
